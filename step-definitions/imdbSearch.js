...
module.exports = function () {
  ...
  this.Then(/^the search result should show result of "([^"]*)"$/, async function (inputText2) {
    ...
    assert.include(resultText, inputText2, 'Could not find the phrase ' + inputText2 + ' in the first search result.');
    await sleep(5000);
  });
